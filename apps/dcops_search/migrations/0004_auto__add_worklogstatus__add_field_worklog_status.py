...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'WorkLogStatus'
        db.create_table('work_log_worklogstatus', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64)),
        ))
        db.send_create_signal('work_log', ['WorkLogStatus'])

        # Adding field 'WorkLog.status'
        db.add_column(u'work_log', 'status', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['work_log.WorkLogStatus']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'WorkLogStatus'
        db.delete_table('work_log_worklogstatus')

        # Deleting field 'WorkLog.status'
        db.delete_column(u'work_log', 'status_id')
    ...
    models = {
        ...
        'work_log.worklog': {
            ...
            'status': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['work_log.WorkLogStatus']"}),
