...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DataCenter.color'
        db.add_column('work_log_datacenter', 'color', self.gf('django.db.models.fields.CharField')(default='blue', max_length=128), keep_default=False)

        # Adding field 'DataCenter.remove'
        db.add_column('work_log_datacenter', 'remove', self.gf('django.db.models.fields.CharField')(default='blue', max_length=128), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DataCenter.color'
        db.delete_column('work_log_datacenter', 'color')

        # Deleting field 'DataCenter.remove'
        db.delete_column('work_log_datacenter', 'remove')
    ...
    models = {
        ...
        'work_log.datacenter': {
            ...
            'remove': ('django.db.models.fields.CharField', [], {'default': "'blue'", 'max_length': '128'})
        },
        'work_log.depends': {
