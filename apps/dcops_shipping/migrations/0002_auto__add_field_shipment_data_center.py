...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Shipment.data_center'
        db.add_column('dcops_shipping_shipment', 'data_center', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['work_log.DataCenter']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Shipment.data_center'
        db.delete_column('dcops_shipping_shipment', 'data_center_id')
