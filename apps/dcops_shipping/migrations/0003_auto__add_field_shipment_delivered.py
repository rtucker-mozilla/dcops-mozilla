...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Shipment.delivered'
        db.add_column('dcops_shipping_shipment', 'delivered', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Shipment.delivered'
        db.delete_column('dcops_shipping_shipment', 'delivered')
